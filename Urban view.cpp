...
void Train()
{
	...
	glBegin(GL_QUADS);                    //Window L1
    glColor3ub(240.0f, 230.0f, 140.0f);
...
int main(int argc, char** argv) {
	...
	cout<<"Group 6\n";
	cout<<"Press d for day and n for night mode.\n";
	...
	cout<<"Press r to make the small boat reappear again.\n";

	cout<<"Use Right and left Array key, to move the bigger boat.\n";
